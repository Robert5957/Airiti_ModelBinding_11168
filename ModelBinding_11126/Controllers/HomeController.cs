using ModelBinding_11126.Models;
using System;
...
namespace ModelBinding_11126.Controllers
{
    public class HomeController : Controller
    {
        ...
        /// <returns></returns>
        public ActionResult OtherOne(Travelinfo TravelData)
        {
           return Json(TravelData);
        }

        [ValidateInput(false)]
        public ActionResult OtherTwo(string Name)
        {
            string AppendHTML = "<div style=\"width:300px; height:3.5em; background-color:darkblue;\">" + Name + "</div>";
            return Content(AppendHTML, "text/html");
        }
